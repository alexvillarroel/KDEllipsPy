...
subroutine reflect5
  ...
  real(kind=pcal) :: sir,sir2,si2r

  real(kind=pcal) :: cor,cor2,co2r
  complex(kind=pcal) :: urxx,utxx,uzxx,urxy,utxy,uzxy,urxz,utxz,uzxz
  complex(kind=pcal) :: uryy,utyy,uzyy,uryz,utyz,uzyz,urzz,utzz,uzzz
  complex(kind=pcal),dimension(1:6) :: ux,uy,uz
