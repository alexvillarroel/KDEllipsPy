...
subroutine reflect3
  ...
  integer :: is0,is1,is2,ic
  complex(kind=pcal) :: rud1,rud2,rud3,rud4,rdu1,rdu2,rdu3,rdu4
  complex(kind=pcal) :: tud1,tud2,tud3,tud4,tdu1,tdu2,tdu3,tdu4,tsh
  complex(kind=pcal) :: egam,enu,rupsh,rdosh,arg

  complex(kind=pcal),dimension(1:2) :: cu1,cd1,cu2,cd2,cu3,cd3,cu4,cd4

  complex(kind=pcal),dimension(1:2,1:2) :: rup,rdo

  complex(kind=pcal) :: cdet,cu1sh,cd1sh,cu2sh,cd2sh
  ...
  do is1 = 1,ncs
     ...
     cdet = (one-rud1)*(one-rud4)-rud2*rud3
     ...
     cdet = (one-rdu1)*(one-rdu4)-rdu2*rdu3
