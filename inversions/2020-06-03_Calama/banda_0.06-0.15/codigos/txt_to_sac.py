...
# Solo procesar estas estaciones (set azimutal aprobado). Vacio = todas.
SELECTED = ["A22F", "A08F", "A09F", "PB19", "A05F", "PB06", "A06F", "A18F", "A23F"]
...
def procesar():
    ...
    if SELECTED:
        stream = stream.__class__([tr for tr in stream if tr.stats.station in SELECTED])
