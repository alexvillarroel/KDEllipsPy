...
map.py
======
Mapa del evento de Copiapo (2025-06-06) adaptado desde el map.py original de
...
MAGNITUDE = 6.36  # USGS W-phase Mww (M0 = 4.385e18 N·m); ajusta a tu valor ISOLA si difiere
...
USED_STATIONS = {"AC01", "A24F", "A28F", "A15C", "A17C", "A06C", "A18C", "A30C"}
...
fig.basemap(
    ...
    frame=[
        ...
        f"{depth_event:.0f} km - Copiapó, Chile"
    ],
)
...
out = os.path.join(BASE, "SAC", "mapa_copiapo.png")
